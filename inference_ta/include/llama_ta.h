...
#define TA_INFERENCE_UUID \
	{ 0xdf437390, 0x7759, 0x4bc4, \
		{ 0xbe, 0x67, 0x62, 0x60, 0x79, 0x87, 0x74, 0x97} }
...
/*
 * TA_LLAMA_CMD_GATHER_MODEL - gather all part of model plaintext to the inference TA
 * param[0] (value.a) in: size of cipher
 *          (value.b) in: global memory offset to write at
 * param[1] unused
 * param[2] unused
 * param[3] unused
 */
#define TA_LLAMA_CMD_GATHER_MODEL 9

/*
 * TA_LLAMA_CMD_PT_BUFFER_CREATE - create buffer to receive model plaintext
 * param[0] (value.a) in: required buffer size
 * param[1] unused
 * param[2] unused
 * param[3] unused
 */
#define TA_LLAMA_CMD_PT_BUFFER_CREATE 10